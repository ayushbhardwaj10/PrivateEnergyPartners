...
class EnergyDateWiseGraphTest(unittest.TestCase):
    ...
    def test_dateWiseEnergy_with_valid_token(self):
        ...
        response = self.application.post('/getEnergyDateWise', data=json.dumps(dateWiseGraph), headers=headers)
        self.assertEqual(response.status_code, 200)

    def test_dateWiseEnergy_with_invalid_token(self):
